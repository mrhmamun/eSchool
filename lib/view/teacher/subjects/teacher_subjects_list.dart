...
class TeacherSubjectsList extends StatefulWidget {
  @override
  _TeacherSubjectsListState createState() => _TeacherSubjectsListState();
}

class _TeacherSubjectsListState extends State<TeacherSubjectsList> {
