...
class _SubCategoriesState extends State<SubCategories> {
  TextEditingController? addsubCategoryController;
  TextEditingController? editsubCategoryController;
  ...
  @override
  void initState() {
    addsubCategoryController = TextEditingController(text: addsubCategory);
    editsubCategoryController = TextEditingController(text: editsubCategory);
    // editsubCategoryController = TextEditingController(text: editsubCategory);
  ...
  void dispose() {
    ...
    editsubCategoryController?.dispose();
                                    ...
                                    if (addsubCategory == null) {
                                      ScaffoldMessenger.of(context)
                                        ...
                                        Globals.customSnackBar(
                                          content:
                                              "subCategory Can't be empty!",
                                        ),
                                      );
                                    } else {
                                      Globals.subCategoryRef
                                          ?.doc(addsubCategory)
                                          .set({
                                        ...
                                        ScaffoldMessenger.of(context)
                                          ...
                                          Globals.customSnackBar(
                                            content:
                                                'subCategory $addsubCategory Added Successfully!',
                                          ),
                                        );
                                      });
                                    }
                    ...
                    Card(
                      ...
                      child: Container(
                        ...
                        child: StreamBuilder<QuerySnapshot>(
                          stream: Globals.subCategoryRef?.snapshots(),
                          builder: (BuildContext context,
                            ...
                            return new ListView.builder(
                              ...
                              //   return new ListTile(
                              //     title: new Text(document.data()?['subCategory']),
