import 'package:eschool/view/login/widgets/login_form.dart';
                    ...
                    child: Row(
                      ...
                      Expanded(
                          ...
                          child: Container(
                            ...
                            child: kIsWeb
                                ? Image.network('assets/assets/images/login-image.png',
                      ...
                      Expanded(
                          ...
                          child: Container(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    kIsWeb
                                        ? Image.network('assets/assets/images/login-form.png',
                                            color: Colors.white,
